...
**Contents:** [Overview](#overview) · [Model](#model) · [Sensitivity analysis](#sensitivity-analysis) · [Digital shadow](#digital-shadow) · [Results](#results) · [Limitations](#limitations) · [Repository](#repository) · [References](#references)
...
*Fig. 2 — Dimensionless sensitivity coefficients $S_j$ at the healthy baseline. Red indicates positive sensitivity (parameter ↑ → output ↑); blue indicates negative.*
...
*Fig. 3 — LV PV loops at the healthy baseline. Red: Lim et al. Blue: calibrated simplified model.*
...
*Fig. 4 — LV PV loops in CHF, six-parameter calibration against Lim et al.*
